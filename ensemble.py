...
for index, name in args:
    ...
    result_travel['avg_travel_time'] = result_travel['avg_travel_time'] / len(args)
result_travel.to_csv('./data/prediction/{}_ensemble_travelTime.csv'.format(exp_name), sep=',', header=True,index=False)
